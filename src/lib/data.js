...
const email = 'kenjwho@gmail.com';
const links = {
	chat: {
		text: 'Schedule a Chat',
		url: 'https://calendar.app.google/TFbsgLYBc88N7ZmM9'
	},
	...
	menu: {
		linkedIn: '	',
		dribbble: 'https://dribbble.com/kenjonespizza',
...
I’m an <code class="text-2xl lg:text-4xl">AI-forward</code> <strong class="font-bold">Front-end Engineer</strong> and <strong class="font-bold">designer</strong> with a decade+ of building for the web.
</p>
<p>
Agentic development is changing how software gets built, and I’m not just keeping up. I’m embracing it as an opportunity. I use AI as a core part of my workflow, keeping a firm hand on the wheel: directing agentic teams & workflows, prompting with precision, and making sure what ships is quality code (not just confident-sounding nonsense).</p>
<p>Outside of work, I’m chasing birds, fostering dogs, grinding bike trails, and occasionally getting humbled by video games (currently ARC Raiders and Mario Tennis).
</p>`;
...
const resume = `<!-- Entry -->
				<div class="flex flex-col md:flex-row justify-start gap-6">
					...
					<div class="-mt-2 md:mt-auto prose prose-sm">
						...
						<h4 class="text-xl font-medium italic">Senior Web Engineer (Community Experience)</h4>
...
const cta = {
	...
	text: `Have a project, a question, or just want to talk shop? I’m always happy to connect. With 15 years across <strong class="font-extrabold">design</strong>, <strong class="font-extrabold">engineering</strong>, <strong class="font-extrabold">consulting</strong>, and <strong class="font-extrabold">AI-augmented development</strong>, I probably have something useful to say — grab some time on my calendar.` // Can be HTML
};
const designs = [
	{
		name: 'FlyUSA',
